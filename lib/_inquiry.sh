...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do Zion CRM que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  printf "   [3] Bloquear Zion CRM\n"
  printf "   [4] Desbloquear Zion CRM\n"
  printf "   [5] Alterar dominio Zion CRM\n"
  printf "\n"
  read -p "> " option
