...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do sistema Zion CRM...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema Zion CRM...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o Zion CRM...${GRAY_LIGHT}"
  printf "\n\n"
